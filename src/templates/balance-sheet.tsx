            ...
            <main className={container}>
                <section>
                    ...
                    <hgroup role="group" aria-roledescription="Heading group">
                        ...
                        <p aria-roledescription="subtitle">{data.attributes.company.ticker}</p>
                    </hgroup>
                    <i>Filing Date: <time>{formatStringDate(data.attributes.filing.filingDate)}</time></i>
                </section>
                <dl>
                    <div className={box}>
                        <dt className={term}>Assets</dt>
                        <dd className={amount}>{formatNumberCurrency(data.attributes.result.Assets)}</dd>
                    </div>
                    <div className={box}>
                        <dt className={term}>Liabilities</dt>
                        <dd className={amount}>{formatNumberCurrency(data.attributes.result.Liabilities)}</dd>
                    </div>
                    <div className={box}>
                        <dt className={term}>Long Term Investments</dt>
                        <dd className={amount}>{formatNumberCurrency(data.attributes.result.LongTermInvestments)}</dd>
                    </div>
                    <div className={box}>
                        <dt className={term}>Short Term Investments</dt>
                        <dd className={amount}>{formatNumberCurrency(data.attributes.result.ShortTermInvestments)}</dd>
                    </div>
                </dl>
            </main>
        </div>
